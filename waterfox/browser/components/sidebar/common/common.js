...
const WATERFOX_SPECIFIC_VALUES = {
  ...
  showTreeCommandsInTabsContextMenuGlobally: false,
  ...
  // suppress notification at the initial startup
  notifiedFeaturesVersion: 99999,
  syncAvailableNotified: true,

  // by our custom module, drag and drop of the tree is natively supported.
  showTabDragBehaviorNotification: false,
  enableWorkaroundForBug1548949: false,

  // covered by our custom module
  enableWorkaroundForBug1875100: false,
};
export const WATERFOX_AUTOMATED_TEST_DEFAULT_VALUES = {
  maxTreeLevel: -1,
  autoAttach: true,
